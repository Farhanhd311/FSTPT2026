        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-x-12 lg:gap-x-16 gap-y-8 mb-8">
          ...
          <div>
            ...
            <ul className="space-y-2.5">
              <li>
                <a href="mailto:fstpt29@eng.unand.ac.id" className="flex items-center gap-2 text-moss/80 hover:text-white text-sm transition-colors duration-200">
                  ...
                  fstpt29@eng.unand.ac.id
                </a>
              </li>
              <li>
                <a href="https://wa.me/6281270031883" target="_blank" className="flex items-center gap-2 text-moss/80 hover:text-white text-sm transition-colors duration-200">
                  <svg className="w-4 h-4 text-fog/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  +62 812-7003-1883 ({t('febi')})
                </a>
              </li>
              <li>
                <a href="https://wa.me/6285278568360" target="_blank" className="flex items-center gap-2 text-moss/80 hover:text-white text-sm transition-colors duration-200">
                  <svg className="w-4 h-4 text-fog/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  +62 852-7856-8360 ({t('jeply')})
                </a>
              </li>
              <li>
                <a href="https://wa.me/628116642443" target="_blank" className="flex items-center gap-2 text-moss/80 hover:text-white text-sm transition-colors duration-200">
                  <svg className="w-4 h-4 text-fog/70 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={1.5} d="M3 5a2 2 0 012-2h3.28a1 1 0 01.948.684l1.498 4.493a1 1 0 01-.502 1.21l-2.257 1.13a11.042 11.042 0 005.516 5.516l1.13-2.257a1 1 0 011.21-.502l4.493 1.498a1 1 0 01.684.949V19a2 2 0 01-2 2h-1C9.716 21 3 14.284 3 6V5z" />
                  </svg>
                  +62 811-6642-443 ({t('masrilayanti')})
                </a>
              </li>
