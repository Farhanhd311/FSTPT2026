      ...
      <div className="bg-pine text-white py-2 relative z-50 border-b border-white/10">
        <div className="w-full px-5 sm:px-8 lg:px-12 flex flex-wrap justify-center md:justify-between items-center gap-y-3 gap-x-8 text-[13px] font-bold uppercase tracking-wider">
          ...
          <div className="flex flex-wrap justify-center items-center gap-x-8 gap-y-4">
            {/* Email Contact */}
            <a href="mailto:fstpt29@eng.unand.ac.id" className="flex items-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-moss/30 px-4 py-2 rounded-2xl transition-all duration-300 group shadow-sm">
              <div className="w-8 h-8 rounded-full bg-white/10 flex items-center justify-center group-hover:bg-moss/20 group-hover:scale-110 transition-all duration-300">
                <svg className="w-4 h-4 text-white group-hover:text-moss" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div className="flex flex-wrap items-center gap-4 md:border-l md:border-white/10 md:pl-8">
              {[
                ...
                <a
                  ...
                  target="_blank"
                  className="flex items-center gap-3 bg-white/5 border border-white/10 hover:bg-white/10 hover:border-moss/30 px-4 py-2 rounded-2xl transition-all duration-300 group shadow-sm transform hover:-translate-y-0.5"
                >
                  <div className="w-8 h-8 rounded-full bg-moss/20 flex items-center justify-center text-moss group-hover:bg-moss/30 group-hover:scale-110 transition-all duration-300">
                  ...
                  <div className="flex flex-col">
                    <span className="text-[9px] uppercase tracking-widest font-bold opacity-40 group-hover:opacity-100 transition-opacity">{contact.name}</span>
                    <span className="text-[12px] font-bold">{contact.phone}</span>
                  </div>
                </a>
              ))}
            </div>
