...
export default function Registration() {
    ...
    const td = useTranslations('registrationData');
                    ...
                    <div className="grid lg:grid-cols-2 gap-16">
                        ...
                        <FadeIn direction="left" delay={100} className="lg:col-span-2">
                            <div className="text-center mb-16">
                                <h2 className="text-4xl font-black text-pine uppercase tracking-tight mb-4">{t('feeTitle')}</h2>
                            ...
                            <div className="flex flex-col gap-12">
                                ...
                                <div className="bg-white rounded-[2.5rem] border border-clay/30 overflow-hidden shadow-2xl shadow-pine/5 flex flex-col md:flex-row">
                                    <div className="bg-pine p-8 md:p-12 text-white relative md:w-1/3 flex flex-col justify-center">
                                        ...
                                        <h3 className="text-3xl font-black leading-tight relative z-10">{td('istsdc')}</h3>
                                        <p className="text-moss/60 text-sm font-bold uppercase tracking-[0.2em] mt-4 relative z-10">{td('istsdcSub')}</p>
                                    ...
                                    <div className="p-8 md:p-12 md:flex-1 grid md:grid-cols-2 gap-10 bg-gradient-to-br from-white to-clay/5">
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <h4 className="font-black text-pine uppercase text-xs tracking-widest">{t('wni')}</h4>
                                            </div>
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <h4 className="font-black text-pine uppercase text-xs tracking-widest">{t('international')}</h4>
                                            </div>
                                            <div className="grid gap-3">
                                                {[
                                ...
                                <div className="bg-white rounded-[2.5rem] border border-clay/30 overflow-hidden shadow-2xl shadow-sage/5 flex flex-col md:flex-row">
                                    <div className="bg-gradient-to-br from-fog to-sage p-8 md:p-12 text-white relative md:w-1/3 flex flex-col justify-center">
                                        ...
                                        <h3 className="text-3xl font-black leading-tight relative z-10">{td('fstpt')}</h3>
                                        <p className="text-white/60 text-sm font-bold uppercase tracking-[0.2em] mt-4 relative z-10">{td('fstptSub')}</p>
                                    ...
                                    <div className="p-8 md:p-12 md:flex-1 grid md:grid-cols-2 gap-10 bg-gradient-to-br from-white to-clay/5">
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <h4 className="font-black text-fog uppercase text-xs tracking-widest">{t('earlyBird')}</h4>
                                            </div>
                                            <div className="grid gap-3">
                                                {[
                                        ...
                                        <div className="space-y-6">
                                            <div className="flex items-center gap-3 mb-2">
                                                ...
                                                <h4 className="font-black text-fog uppercase text-xs tracking-widest">{t('reguler')}</h4>
                                            </div>
                                            <div className="grid gap-3">
                                                {[
                            ...
                            <div className="mt-16 p-8 bg-clay/5 border border-clay/20 rounded-[2rem] relative overflow-hidden group">
                                ...
                                <p className="text-sm text-pine font-medium leading-relaxed italic relative z-10 pr-4">
                                    <strong className="text-pine font-black not-italic block mb-2 uppercase tracking-widest text-[10px]">{t('note')}</strong>
                                    {t('noteDesc')}
                                </p>
                            </div>
                        </FadeIn>
                        ...
                        <FadeIn direction="right" delay={200} className="lg:col-span-2">
                            <div className="bg-white rounded-[2.5rem] p-12 shadow-2xl border border-clay/20 text-center relative overflow-hidden group">
                                ...
                                <div className="relative z-10 max-w-2xl mx-auto">
                                    ...
                                    <h3 className="text-3xl font-black text-pine mb-6 uppercase tracking-tight">{t('ctaTitle')}</h3>
