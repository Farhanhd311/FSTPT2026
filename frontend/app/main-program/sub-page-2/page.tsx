...
export default function MainProgramSubPage2() {
  return (
    <>
      <Navigation />
      <main className="min-h-screen py-16 lg:py-24 bg-white">
        <div className="max-w-8xl mx-auto px-15 space-y-10">
          <h1 className="text-4xl lg:text-5xl font-bold text-pine mb-6">
            Main Program - <span className="text-transparent bg-clip-text bg-gradient-to-r from-fog to-sage">Sub Page 2</span>
          </h1>
          <p className="text-lg text-sage mb-8">
            Konten untuk Main Program Sub Page 2 akan ditambahkan di sini.
          </p>
